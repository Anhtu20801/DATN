...
namespace QLSV.Data.Migrations
{
    ...
    [Migration("20230427153923_addUserTable")]
            ...
            modelBuilder.Entity("QLSV.Model.Models.Attendance", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AttendanceId = 1,
                            AttenTime = new DateTime(2023, 4, 27, 22, 39, 22, 484, DateTimeKind.Local).AddTicks(8389),
                            Check = true,
                            CourseId = 1,
                            StudentId = 1,
                            TeacherId = 1
                        ...
                        {
                            AttendanceId = 2,
                            AttenTime = new DateTime(2023, 4, 27, 22, 39, 22, 484, DateTimeKind.Local).AddTicks(8406),
                            Check = true,
                            CourseId = 1,
                            StudentId = 1,
                            TeacherId = 1
