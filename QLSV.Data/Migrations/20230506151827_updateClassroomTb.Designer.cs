...
namespace QLSV.Data.Migrations
{
    ...
    [Migration("20230506151827_updateClassroomTb")]
    partial class updateClassroomTb
    {
            ...
            modelBuilder.Entity("QLSV.Model.Models.Attendance", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AttendanceId = 1,
                            AttenTime = new DateTime(2023, 5, 6, 22, 18, 26, 379, DateTimeKind.Local).AddTicks(9224),
                            Check = true,
                            ClassroomId = 1,
                            StudentId = 1
                        });
