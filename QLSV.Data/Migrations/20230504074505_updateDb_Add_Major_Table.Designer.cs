...
namespace QLSV.Data.Migrations
{
    ...
    [Migration("20230504074505_updateDb_Add_Major_Table")]
    partial class updateDb_Add_Major_Table
    {
            ...
            modelBuilder.Entity("QLSV.Model.Models.Attendance", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AttendanceId = 1,
                            AttenTime = new DateTime(2023, 5, 4, 14, 45, 3, 964, DateTimeKind.Local).AddTicks(6104),
                            Check = true,
                            CourseId = 1,
                            StudentId = 1,
                            TeacherId = 1
                        ...
                        {
                            AttendanceId = 2,
                            AttenTime = new DateTime(2023, 5, 4, 14, 45, 3, 964, DateTimeKind.Local).AddTicks(6120),
                            Check = true,
                            CourseId = 1,
                            StudentId = 1,
                            TeacherId = 1
